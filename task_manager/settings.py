...
DATABASES_AVAILABLE = {
    ...
    'postgres': {
        ...
        'NAME': os.getenv('PG_NAME', 'task_manager'),
        'USER': os.getenv('PG_USERNAME', 'admin'),
...
DATABASES = {
    'default': DATABASES_AVAILABLE[
        DATABASE] if DATABASE in DATABASES_AVAILABLE.keys() else
    DATABASES_AVAILABLE['sqlite']
}
